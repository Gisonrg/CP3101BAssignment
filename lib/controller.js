...
function slideSwitch() {
	if (current_pic<5){
		$('#slide-show .slide'+current_pic+'').fadeIn();		
	}
	current_pic++;
	if (current_pic>=6) {
		$('#slide-show .slide1').fadeOut();
		$('#slide-show .slide2').fadeOut();
		$('#slide-show .slide3').fadeOut();
	}
	if (current_pic==7) {
		$('#slide-show .slide4').fadeOut();
		current_pic=1;
	}
